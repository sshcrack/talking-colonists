...
New to it, or playing with addons? When you first arrive in your colony, a citizen welcomes you and hands you the **Colony Handbook** (you can also craft one from a book and a paper): it has a chapter on talking to citizens and one per installed addon. Your citizens know those chapters too, so you can simply ask them how something works.
